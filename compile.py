...
compiler.add(compilation_name="C05", source_code="src/actions/exemples/PROG-CRIAR-TABELA.cob", 
...
compiler.add(compilation_name="C07", source_code="src/actions/exemples/PROG-CONSULTA-SQL.cob", 
